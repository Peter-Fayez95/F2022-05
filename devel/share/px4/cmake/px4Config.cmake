...
if("TRUE" STREQUAL "TRUE")
  set(px4_SOURCE_PREFIX /home/zewaill/catkin_ws/src/PX4-Autopilot)
  set(px4_DEVEL_PREFIX /home/zewaill/catkin_ws/devel)
  set(px4_INSTALL_PREFIX "")
  set(px4_PREFIX ${px4_DEVEL_PREFIX})
else()
  set(px4_SOURCE_PREFIX "")
  set(px4_DEVEL_PREFIX "")
  set(px4_INSTALL_PREFIX /home/zewaill/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'px4' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zewaill/catkin_ws/src/PX4-Autopilot/${idir}'.  ${_report}")
    endif()
